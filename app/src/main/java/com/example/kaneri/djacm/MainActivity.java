...
public class MainActivity extends AppCompatActivity implements CommitteeFragment.OnFragmentInteractionListener, EventsFragment.OnFragmentInteractionListener, HomeFragment.OnFragmentInteractionListener, SponsorsFragment.OnFragmentInteractionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Uri uri = Uri.parse("http://djacm.in/"); // missing 'http://' will cause crashed
